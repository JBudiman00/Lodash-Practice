...
function novemberArtist() {
    ...
    var nameFound = false;
    var ct = 0;
    _.times(abbeyRoadRecords.length, function () {
        nameFound = false;
        arrArtist.forEach(function (a) {
...
function lastBeatlesSong() {
    return _.findLast(abbeyRoadRecords, function (e) {
        return _.get(e, 'artist') === 'The Beatles';
    });
}
var ArtistYear = /** @class */ (function () {
    function ArtistYear(aN, aY, aM) {
        this.artistName = aN;
        this.artistYr = aY;
        this.artistMonth = aM;
    }
...
function lastSixties() {
    var ct = 0;
    var artist60s = [new ArtistYear("dummy", 1959, 0)];
    _.times(abbeyRoadRecords.length, function () {
